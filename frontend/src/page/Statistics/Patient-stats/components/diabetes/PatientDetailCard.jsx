      ...
      <div id="side-card">
        <div className="flex flex-col gap-2" id="fcon">
          ...
          <div className="flex flex-col items-center gap-4 cursor-pointer">
            ...
            <p className="font-medium">Vatsav</p>
        ...
        <div id="tcon">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">
                Blood Pressure (Distolic)
              </span>
              <span className="font-medium text-sm ">70 mmHg</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">
                Serum Cholesterol
            ...
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">Glucose</span>
              <span className="font-medium text-sm ">110 mg/dL</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">
                Max Heart Rate
            ...
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">BMI</span>
              <span className="font-medium text-sm ">28.6</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">
                Diabetes Pedigree Function
              </span>
              <span className="font-medium text-sm ">0.256</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-400">Insulin</span>
